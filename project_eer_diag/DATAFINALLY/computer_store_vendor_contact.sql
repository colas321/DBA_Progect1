...
CREATE TABLE `vendor_contact` (
  ...
  PRIMARY KEY (`vendor_phone`),
  KEY `vendor_name_fk_idx` (`vendor_name`) /*!80000 INVISIBLE */,
  CONSTRAINT `vendor_name_fk` FOREIGN KEY (`vendor_name`) REFERENCES `vendors` (`vendor_name`) ON UPDATE CASCADE
